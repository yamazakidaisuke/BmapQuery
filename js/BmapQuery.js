...
//********************************************************************
// BingMaps v8
// BmapQuery: v0.8 ( https://mapapi.org/indexb.php )
//********************************************************************
     ...
     */
         ...
         */
            },
            {
                ...
                value: function onMap(event, callback) {
                    ...
                    if (event == "viewchange")
                        Microsoft.Maps.Events.addHandler(this.map, "viewchange", callback);
                    if (event == "viewchangeend")
                        Microsoft.Maps.Events.addHandler(
                            this.map,
                            "viewchangeend",
                            callback
                    ...
                    if (event == "click")
                        Microsoft.Maps.Events.addHandler(this.map, "click", callback);
                    if (event == "dblclick")
                        Microsoft.Maps.Events.addHandler(this.map, "dblclick", callback);
                    if (event == "rightclick")
                        Microsoft.Maps.Events.addHandler(this.map, "rightclick", callback);
                    if (event == "mousedown")
                        Microsoft.Maps.Events.addHandler(this.map, "mousedown", callback);
                    if (event == "mouseout")
                        Microsoft.Maps.Events.addHandler(this.map, "mouseout", callback);
                    if (event == "mouseover")
                        Microsoft.Maps.Events.addHandler(this.map, "mouseover", callback);
                    if (event == "mouseup")
                        Microsoft.Maps.Events.addHandler(this.map, "mouseup", callback);
                    if (event == "mousewheel")
                        Microsoft.Maps.Events.addHandler(this.map, "mousewheel", callback);
                    if (event == "maptypechanged")
                        Microsoft.Maps.Events.addHandler(
                            this.map,
                            "maptypechanged",
                            callback
         ...
         */
            },
            {
                ...
                value: function onPin(pushpin, event, callback) {
                    ...
                    if (event == "click")
                        Microsoft.Maps.Events.addHandler(pushpin, "click", callback);
                    if (event == "mousedown")
                        Microsoft.Maps.Events.addHandler(pushpin, "mousedown", callback);
                    if (event == "mouseout")
                        Microsoft.Maps.Events.addHandler(pushpin, "mouseout", callback);
                    if (event == "mouseover")
                        Microsoft.Maps.Events.addHandler(pushpin, "mouseover", callback);
                    if (event == "mouseup")
                        Microsoft.Maps.Events.addHandler(pushpin, "mouseup", callback);
                }
                /**
         * pushpin:Delete
         * @method deletePin
         ...
         */
            },
            {
                ...
                value: function _createScaledPushpin(
                location,
                 imgUrl,
                 scale,
                 anchor1,
                    ...
                    Microsoft.Maps.loadModule("Microsoft.Maps.Directions", function() {
                        ...
                        Microsoft.Maps.Events.addHandler(
                            ...
                            function(e) {
                                ...
                                var distance =
                                    Math.round(e.routeSummary[routeIdx].distance * 100) / 100; //Get the distance units used to calculate the route.
            ...
            },
            {
                ...
                value: function selectedSuggestion(searchBox, searchBoxContainer) {
                    ...
                    Microsoft.Maps.loadModule("Microsoft.Maps.AutoSuggest", function() {
                        ...
                        manager.attachAutosuggest(searchBox, searchBoxContainer, function(
                                                  result
                        ) {
