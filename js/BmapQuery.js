...
var Bmap =
    ...
    function () {
        ...
        _createClass(Bmap, [{
            ...
            key: "infoboxLayers",
            value: function infoboxLayers(option, flg) {
                var map = this.map;
                var layer = [];
                var pin = [];
                var infobox = [];
            ...
            value: function setLocationBoundary(searchs, zoom, type) {
                ...
                Microsoft.Maps.Events.addHandler(map, 'viewchangeend', updateLayerVisibility); //Do an initial update of the visibility.
                ...
                function updateLayerVisibility() {
                    ...
                    var layer; //Loop through the layers in the map and check to see if it has zoomRange metadata.
