    ...
    _createClass(Bmap, [{
        ...
        */
        ...
        value: function onPin(pushpin, event, callback) {
            //Param Check
            if ((typeof pushpin === "undefined" ? "undefined" : _typeof(pushpin)) !== "object" || event === "" || typeof callback !== "function") {
                return false;
            }
        ...
        */
        ...
        value: function direction(details, mode, from, to) {
            var map = this.map;
            var directionsManager = void 0;
            var waypoints = arguments[4];
            ...
            Microsoft.Maps.loadModule('Microsoft.Maps.Directions', function () {
                ...
                var start = new Microsoft.Maps.Directions.Waypoint({ address: from });
                directionsManager.addWaypoint(start);
                //Waypoints
                if (typeof waypoints != "undefined") {
                    waypoints.forEach(function (waypoint) {
                        var way = new Microsoft.Maps.Directions.Waypoint({ address: waypoint });
                        directionsManager.addWaypoint(way);
                    });
                }
                //EndPoint
                var end = new Microsoft.Maps.Directions.Waypoint({ address: to });
